...
const DateDonut = (props: DateDonutProps) => {
    ...
    return (
        <div className="col-span-12 bg-white px-5 pt-7.5 pb-5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:col-span-5">
